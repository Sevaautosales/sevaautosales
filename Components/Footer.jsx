          ...
          <div className={`lg:col-span-3 transform transition-all duration-1000 ${isVisible ? 'translate-y-0' : 'translate-y-16'}`}>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="group">
                <div className="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center transition-all duration-300 group-hover:bg-blue-600">
                  <svg className="h-5 w-5 text-gray-300 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className={`lg:col-span-2 transform transition-all duration-1000 delay-200 ${isVisible ? 'translate-y-0' : 'translate-y-16'}`}>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center group">
                ...
                <span className="text-gray-300 text-sm">+91 99043 66000</span>
              </li>
              <li className="flex items-center group">
                <div className="flex-shrink-0 mr-3 p-2 rounded-full bg-gray-700 group-hover:bg-blue-600 transition-colors duration-300">
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-300 text-sm">+91 81283 79660</span>
              </li>
              <li className="flex items-center group">
                <div className="flex-shrink-0 mr-3 p-2 rounded-full bg-gray-700 group-hover:bg-blue-600 transition-colors duration-300">
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-300 text-sm">sevaautosales@gmail.com</span>
              </li>
            </ul>
          </div>
